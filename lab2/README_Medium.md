...
````
## 1. Сначала обновим зависимости:
```` python
#активируем виртуальное окружение (если не активно)
source venv/bin/activate  #если Mac/Linux
#или
venv\Scripts\activate  #если Windows

#установим seaborn и pandas
pip install seaborn pandas

#обновим requirements.txt
pip freeze > requirements.txt
````
## 1.2. Установка необходимых библиотек

В активированном виртуальном окружении установлены следующие библиотеки:
- `numpy` - для математических вычислений и работы с массивами
- `matplotlib` - для базовой визуализации данных
- `seaborn` - для расширенной статистической визуализации (Medium сложность)
- `pandas` - для работы с данными в формате DataFrame
## 1.3 Создан файл `requirements.txt` для фиксации всех зависимостей проекта. Это позволяет быстро развернуть аналогичную среду на другом компьютере командой:
```` python
pip install -r requirements.txt
````
## 1.4 Реализация на Seaborn
### Что такое Seaborn?
- Seaborn — это библиотека для статистической визуализации данных на основе matplotlib. Она предоставляет:
1) Эстетичные стили оформления "из коробки"
2) Автоматические цветовые палитры
3) Упрощенный синтаксис
4) Встроенную поддержку pandas DataFrame
